...
from transformers import RobertaConfig, RobertaModel, AutoModel, AutoConfig
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.clssify = nn.Linear(self.config.hidden_size * 3, 2) # change when class need 3 or 2
